...
export const incrementSaga = (amount: number) => action(HomeActions.INCREMENT_SAGA, amount);
export const decrementSaga = (amount: number) => action(HomeActions.DECREMENT_SAGA, amount);